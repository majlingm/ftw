...
-- Table `ftw3`.`Media`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ftw3`.`Media` ;

CREATE  TABLE IF NOT EXISTS `ftw3`.`Media` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  `tumbnail` TINYINT NULL ,
  `small` TINYINT NULL ,
  `medium` TINYINT NULL ,
  `large` TINYINT NULL ,
  `extra_large` TINYINT NULL ,
...
-- -----------------------------------------------------
-- Table `ftw3`.`Media_labels`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ftw3`.`Media_labels` ;

CREATE  TABLE IF NOT EXISTS `ftw3`.`Media_labels` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `title` VARCHAR(45) NOT NULL ,
  `parent_id` INT NULL ,
  `parent` TINYINT NULL ,
...
-- -----------------------------------------------------
-- Table `ftw3`.`Media_has_Media_labels`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ftw3`.`Media_has_Media_labels` ;

CREATE  TABLE IF NOT EXISTS `ftw3`.`Media_has_Media_labels` (
  `Media_id` INT NOT NULL ,
  `Media_labels_id` INT NOT NULL ,
  PRIMARY KEY (`Media_id`, `Media_labels_id`) ,
  INDEX `fk_Media_has_Media_lables_Media_lables1` (`Media_labels_id` ASC) ,
  CONSTRAINT `fk_Media_has_Media_lables_Media1`
    FOREIGN KEY (`Media_id` )
    REFERENCES `ftw3`.`Media` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Media_has_Media_lables_Media_lables1`
    FOREIGN KEY (`Media_labels_id` )
    REFERENCES `ftw3`.`Media_labels` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
